...
/* General */
x_Access                    : 'Access ',
x_AddessDesc                : 'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you Nowon or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere.',
x_Address                   : 'Your Address ',
x_Cancel                    : 'Cancel ',
x_CSV                       : 'CSV file (unencrypted) ',
x_Download                  : 'Download ',
x_Json                      : 'JSON File (unencrypted) ',
x_JsonDesc                  : 'This is the unencrypted, JSON format of your private key. This means you do not need the password but anyone who finds your JSON can access your wallet & Nowon without the password. ',
...
/* Header */
CX_Tagline                  : 'Open Source JavaScript Client-Side Nowon Wallet Chrome Extension ',
...
MEW_Tagline                 : 'Open Source JavaScript Client-Side Nowon Wallet ',
MEW_Warning_1               : 'Always check the URL before accessing your wallet or creating a new wallet. Beware of phishing sites! ',

/* Footer */
FOOTER_1                    : 'Free, open-source, client-side interface for generating Nowon wallets &amp; more. Interact with the Nowon blockchain easily &amp; securely. Double-check the URL ( .com ) before unlocking your wallet.',
...
ADD_Ledger_2                : 'Open the Nowon application (or a contract application) ',
...
ADD_Warning_1               : 'You can add any account to "watch" on the wallets tab without uploading a private key. This does ** not ** mean you have access to this wallet, nor can you transfer Nowon from it. ',
...
SENDModal_Content_4         : 'NOTE: If you encounter an error, you most likely need to add Nowon to your account to cover the gas cost of sending tokens. Gas is paid in Nowon. ',
...
HELP_Remind_Desc_1          : '**Nowon, MyEtherWallet.com & MyEtherWallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Nowon**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet.com & MyEtherWallet CX are not "web wallets". You do not create an account or give us your Nowon to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain. ',
...
HELP_0_Desc_1               : 'MyEtherWallet gives you the ability to generate new wallets so you can store your Nowon yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**. ',
...
HELP_0_Desc_5               : 'Transfer Nowon to this new wallet. ',
...
HELP_2a_Desc_2              : 'Save the address. You can keep it to yourself or share it with others. That way, others can transfer Nowon to you. ',
HELP_2a_Desc_3              : 'Save versions of the private key. Do not share it with anyone else. Your private key is necessary when you want to access your Nowon to send it! There are 3 types of private keys ',
...
HELP_3_Desc_1               : '**Before you send any Nowon to your new wallet**, you should ensure you have access to it. ',
...
HELP_3_Desc_8               : 'If you are planning on holding a large amount of Nowon, we recommend that send a small amount of Nowon from new wallet before depositing a large amount. Send 0.001 Nowon to your new wallet, access that wallet, send that 0.001 Nowon to another address, and ensure everything works smoothly. ',

HELP_4_Title                : '4) How do I send Nowon from one wallet to another? ',
HELP_4_Desc_1               : 'If you plan to move a large amount of Nowon, you should test sending a small amount to your wallet first to ensure everything goes as planned. ',
HELP_4_Desc_2               : 'Navigate to the "Send Nowon & Tokens" page. ',
...
HELP_4CX_Title              : '4) How do I send Nowon using MyEtherWallet CX? ',
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send Nowon & Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Send Nowon & Tokens" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Send Nowon & Tokens" page. ',
...
HELP_8_Desc_2               : 'If MyEtherWallet.com goes down, you would have to find another way (like geth or Nowon Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Nowon out of MyEtherWallet because it\'s not in MyEtherWallet. It\'s in whatever wallet your generated via our site. ',
HELP_8_Desc_3               : 'You can import your unencrypted private key and your Geth/Mist Format (encrypted) files directly into geth / Nowon Wallet / Mist very easily now. See question #12 below. ',
...
HELP_8CX_Desc_2             : 'That said, it is **very important** that you back up all your information for any new wallets generated with MyEtherWallet CX. That way if anything happens to MyEtherWallet CX or your computer, you still have all the information necessary to access your Nowon. See the #2a for how to back up your wallets. ',
...
HELP_9_Title                : '9) Is the "Send Nowon & Tokens" page offline? ',
...
HELP_12_Title               : '12) How do I import a wallet created with MyEtherWallet into geth / Nowon Wallet / Mist? ',
...
HELP_12_Desc_7              : 'Open the Nowon Wallet application. ',
...
HELP_12_Desc_20             : 'This will prompt you to make a new password. This is the password you will use in geth / Nowon Wallet / Mist whenever you send a transaction, so don\'t forget it. ',
HELP_12_Desc_21             : 'After successful import, delete `nothing_special_delete_me.txt` ',
HELP_12_Desc_22             : 'The next time you open the Nowon Wallet application, your account will be listed under "Accounts". ',
...
HELP_12_Desc_26             : 'This will prompt you to make a new password. This is the password you will use in geth / Nowon Wallet / Mist whenever you send a transaction, so don\'t forget it. ',
HELP_12_Desc_27             : 'After successful import, delete `nothing_special_delete_me.txt` ',
HELP_12_Desc_28             : 'The next time you open the Nowon Wallet application, your account will be listed under "Accounts". ',
...
HELP_13_Desc_1              : 'This means you do not have enough Nowon in your account to cover the cost of gas. Each transaction (including token and contract transactions) require gas and that gas is paid in Nowon. The number displayed is the amount required to cover the cost of the transaction in Wei. Take that number, divide by `1000000000000000000`, and subtract the amount of Nowon you were trying to send (if you were attempting to send Nowon). This will give you the amount of Nowon you need to send to that account to make the transaction. ',
...
HELP_15_Desc_1              : 'Accounts will only show up in a blockchain explorer once the account has activity on it&mdash;for example, once you have transferred some Nowon to it. ',
...
HELP_20_Desc_1              : 'Wherever you saved it. ;) It also was emailed to you, so check there. Look for the file called `"Nowon_wallet_backup.json"` and select that file. This wallet file will be encrypted with a password that you created during the purchase of the pre-sale. ',
...
HELP_21_Desc_2              : 'Long ELI5 Version: So Nowon is based on [Public Key Cryptography](https://en.wikipedia.org/wiki/Public-key_cryptography), specifically [Elliptic curve cryptography](https://eprint.iacr.org/2013/734.pdf) which is very widely used, not just in Ethereum. Most servers are protected via ECC. Bitcoin uses the same, as well as SSH and TLS and a lot of other stuff. The Nowon keys specifically are 256-bit keys, which are stronger than 128-bit and 192-bit, which are also widely used and still considered secure by experts. ',
HELP_21_Desc_3              : 'In this you have a private key and a public key. The private key can derive the public key, but the public key cannot be turned back into the private key. The fact that the internet and the world’s secrets are using this cryptography means that if there is a way to go from public key to private key, your lost Nowon is the least of everyone’s problems. ',
HELP_21_Desc_4              : 'Now, that said, YES if someone else has your private key then they can indeed send Nowon from your account. Just like if someone has your password to your email, they can read and send your email, or the password to your bank account, they could make transfers. You could download the Keystore version of your private key which is the private key that is encrypted with a password. This is like having a password that is also protected by another password. ',
...
HELP_21_Desc_8              : 'Of course, this all assumes that keys are generated in a truly random way & with sufficient entropy. The keys generated here meet that criteria, as do Jaxx and Mist/geth. The Nowon wallets are all pretty good. Keys generated by brainwallets do not, as a person\'s brain is not capable of creating a truly random seed. There have been a number of other issues regarding lack of entropy or seeds not being generated in a truly random way in Bitcoin-land, but that\'s a separate issue that can wait for another day. ',
